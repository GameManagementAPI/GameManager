...
/**
 * Triggered when a player quits a team
 * @see de.c4vxl.gamemanager.gma.event.type.GameTeamEvent
 *
 * @param team The team the player left
 * @param player The player that triggered the event
 * @param game The game the player is currently in
 */
data class GamePlayerTeamQuitEvent(override val team: Team, val player: GMAPlayer, val game: Game) : GameTeamEvent(team)