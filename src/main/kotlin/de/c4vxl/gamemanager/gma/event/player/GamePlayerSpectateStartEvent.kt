...
/**
 * Triggered when a player starts to spectate a game
 * @see de.c4vxl.gamemanager.gma.event.type.GamePlayerEvent
 *
 * @param player The player that triggered the event
 * @param game The game the player is currently in
 */
data class GamePlayerSpectateStartEvent(override val player: GMAPlayer, val game: Game) : GamePlayerEvent(player)