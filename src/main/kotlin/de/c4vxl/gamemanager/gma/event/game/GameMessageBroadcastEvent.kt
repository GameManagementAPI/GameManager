 ...
 */
data class GameMessageBroadcastEvent(override val game: Game, val languageChild: String?, val translationKey: String, val translationArgs: List<String>, val audience: List<GMAPlayer>) : GameEvent(game)